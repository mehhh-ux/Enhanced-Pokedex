/**
 * PokemonView.java is responsible for all outputs in the pokemon menu.
 */
package Pokemon;
...
public class PokemonView {
    ...
    /**
     * Prints and displays the attributes of every pokemon objects in an ArrayList.
     * @param pokemons is a list of pokemon objects.
     */
